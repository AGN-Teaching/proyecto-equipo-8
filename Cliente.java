...
public class Cliente {
    ...
    public void verEstadoPedido(Cliente cliente, Taqueria taqueria) {
        List<Pedido> listaDePedidos = taqueria.getPedidos();
        ...
        if (listaDePedidos.isEmpty()) {
            ...
            for (Pedido pedido : listaDePedidos) {
                if(pedido.getStatus().equals("Pendiente") && pedido.getCliente().getTelefono().equals(cliente.getTelefono())) {
                    System.out.println("Estado del Pedido (ID: " + pedido.getId() + "):");
                    System.out.println("Fecha del Pedido: " + pedido.getFechaPedido());
                    System.out.println("Hora del Pedido: " + pedido.getHoraPedido());
                    System.out.println("Hora estimada: "+pedido.getHoraEstimada());
                    System.out.println("Forma de Entrega: " + pedido.getFormaEntrega());
                    System.out.println("Forma de Pago: " + pedido.getFormaPago());
                    System.out.println("Productos:");
                    for (Producto producto : pedido.getProductos()) {
                    ...
                    System.out.println("Su Pedido ya ha sido entregado");
                }else if (pedido.getStatus().equals("Entregado") && pedido.getCliente().getTelefono().equals(cliente.getTelefono())){
                    System.out.println("Su pedido con el ID" + pedido.getId()+" ha sido entregado");
                }
            }
        }
    }

    public void historialDePedidos(Taqueria taqueria) {
        List<Pedido> listaDePedidos = taqueria.getPedidos();
        ...
        if (listaDePedidos.isEmpty()) {
            ...
            for (Pedido pedido : listaDePedidos) {
                if (pedido.getStatus().equals("Entregado")) {
